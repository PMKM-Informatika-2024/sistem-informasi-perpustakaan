  ...
  <div>
    ...
    <x-partial.modal name="delete all">
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
        ...
        <form action="{{ route('delete all category') }}" method="POST" class="p-4 text-center md:p-5">
          @csrf
          @method('DELETE')
          ...
          <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Hapus semua kategori?</h3>
