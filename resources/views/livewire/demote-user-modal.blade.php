<div x-cloak x-data="{ open: false, name: '' }" x-show="open" x-on:demote.window="open = true; name = $event.detail.name" tabindex="-1"
  ...
  <div class="relative max-h-full w-full max-w-md p-4">
    <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
      ...
      <div class="p-4 text-center md:p-5">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin mau demote <span x-text="name"></span>?</h3>
        <button type="submit" x-on:click="$wire.demote(name)" type="button" class="inline-flex items-center rounded-lg bg-red-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800">
          Yakin
        </button>
