<div x-cloak x-data="{ open: false }" x-show="open" x-on:apa.window="open = true" x-on:close-modal="open = false"
  class="fixed left-0 right-0 top-0 z-50 flex h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden bg-black/30 backdrop-blur md:inset-0">
