    ...
    <div class="space-y-4">
      ...
      <div class="flex justify-end">
        <button type="submit"
          ...
          <svg wire:loading aria-hidden="true" class="size-4 -ms-1 me-1 inline animate-spin dark:fill-white dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
