<div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
  ...
  <div class="p-4 text-center md:p-5">
    ...
    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Hapus peminjaman {{ $loan?->book->title }} yang dipinjam {{ $loan?->member->name }}?</h3>
    <button type="submit" wire:click="delete" type="button" class="inline-flex items-center rounded-lg bg-red-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800">
      Yakin
    </button>
