    ...
    <div class="space-y-4">
      <div>
        ...
        <input type="text" wire:model="name" id="name"
          ...
          placeholder="cth: Komputer" required>
        @error('name')
      ...
      <div>
        ...
        <textarea id="description" rows="4" wire:model="description"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:read-only:bg-gray-600 dark:read-only:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
      ...
      <div class="flex justify-end">
        <button type="submit"
          ...
          <svg wire:loading aria-hidden="true" class="size-4 -ms-1 me-2 inline animate-spin dark:fill-white dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
